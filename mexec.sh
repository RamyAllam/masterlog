...
dialog --title "Multi Commands Executions" \
...
dialog --title "Multi Commands Executions" \
--backtitle "Master Log v1.0 --By : Ramy Allam. linux@ramyallam.com" \
--inputbox "Enter Command" 12 40 2> cmd.txt
...
echo "User : `whoami` Type : MExec $COMMAND on ( dedicated servers group - $FINDHOSTNAME ) at `date`" >> logs/mexec.txt
echo "Executing $COMMAND on $FINDHOSTNAME \n"
ssh -p $FINDHOSTPORT $FINDHOSTUSER@$FINDHOSTIP $COMMAND
echo "######################################################"
done
...
FINDHOSTPORT=`echo $i | cut -d ":" -f4`
FINDHOSTUSER=`echo $i | cut -d ":" -f3`
echo "User : `whoami` Type : MExec $COMMAND on ( vps nodes group - $FINDHOSTNAME ) at `date`" >> logs/mexec.txt
echo "Executing $COMMAND on $FINDHOSTNAME"
ssh -p $FINDHOSTPORT $FINDHOSTUSER@$FINDHOSTIP $COMMAND
echo "######################################################"
done
...
FINDHOSTPORT=`echo $i | cut -d ":" -f4`
FINDHOSTUSER=`echo $i | cut -d ":" -f3`
echo "User : `whoami` Type : MExec $COMMAND on ( vps group - $FINDHOSTNAME ) at `date`" >> logs/mexec.txt
echo "Executing $COMMAND on $FINDHOSTNAME"
ssh -p $FINDHOSTPORT $FINDHOSTUSER@$FINDHOSTIP $COMMAND
echo "######################################################"
done
...
FINDHOSTPORT=`echo $i | cut -d ":" -f4`
FINDHOSTUSER=`echo $i | cut -d ":" -f3`
echo "User : `whoami` Type : MExec $COMMAND on ( shared servers group - $FINDHOSTNAME ) group at `date`" >> logs/mexec.txt
echo "Executing $COMMAND on $FINDHOSTNAME"
ssh -p $FINDHOSTPORT $FINDHOSTUSER@$FINDHOSTIP $COMMAND
echo "######################################################"
done
...
FINDHOSTPORT=`echo $i | cut -d ":" -f4`
FINDHOSTUSER=`echo $i | cut -d ":" -f3`
echo "User : `whoami` Type : MExec $COMMAND on ( all servers group - $FINDHOSTNAME ) at `date`" >> logs/mexec.txt
echo "Executing $COMMAND on $FINDHOSTNAME"
ssh -p $FINDHOSTPORT $FINDHOSTUSER@$FINDHOSTIP $COMMAND
echo "######################################################"
done
